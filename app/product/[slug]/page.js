      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-2 mt-6">
          <a href="https://discord.gg/hxkk9XhdwT"
            ...
            className="flex-1 flex items-center justify-center gap-2 text-sm font-medium px-4 py-3 rounded-xl bg-[#1E2030] border border-[#2A2C3D] hover:border-[#4FA8A0] text-[#C7C9D9] transition-colors"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 flex items-center justify-center gap-2 text-sm font-medium px-4 py-3 rounded-xl bg-[#E8A33D] text-[#14151F] hover:bg-[#f0b158] transition-colors"
          >
            <span>☕</span>
            Buy me a coffee
          </a>
