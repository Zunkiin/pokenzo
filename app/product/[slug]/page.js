      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-2 mt-6">
          <a href="https://discord.gg/hxkk9XhdwT"
            ...
            className="flex-1 flex items-center justify-center gap-2 text-sm font-semibold px-4 py-3 rounded-xl bg-[#4FA8A0]/15 border border-[#4FA8A0] text-[#4FA8A0] hover:bg-[#4FA8A0]/25 transition-colors"
          >
